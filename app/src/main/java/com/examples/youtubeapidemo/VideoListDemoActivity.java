...
import com.examples.youtubeapidemo.util.VideoEntry;
...
public final class VideoListDemoActivity extends Activity implements OnFullscreenListener {
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            adapter = new PageAdapter(getActivity(), Ids.VideoListDemoActivity.VIDEO_LIST);
        }
        ...
        public void onListItemClick(ListView l, View v, int position, long id) {
            String videoId = Ids.VideoListDemoActivity.VIDEO_LIST.get(position).videoId;
