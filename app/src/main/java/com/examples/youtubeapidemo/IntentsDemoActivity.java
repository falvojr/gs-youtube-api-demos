...
public final class IntentsDemoActivity extends Activity implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (clickedIntentItem.type) {
            case PLAY_VIDEO:
                intent = YouTubeIntents.createPlayVideoIntentWithOptions(this, Ids.IntentsDemoActivity.VIDEO_ID, true, false);
                startActivity(intent);
                break;
            case OPEN_PLAYLIST:
                intent = YouTubeIntents.createOpenPlaylistIntent(this, Ids.IntentsDemoActivity.PLAYLIST_ID);
                startActivity(intent);
                break;
            case PLAY_PLAYLIST:
                intent = YouTubeIntents.createPlayPlaylistIntent(this, Ids.IntentsDemoActivity.PLAYLIST_ID);
                startActivity(intent);
                break;
            case OPEN_SEARCH:
                intent = YouTubeIntents.createSearchIntent(this, Ids.IntentsDemoActivity.USER_ID);
                startActivity(intent);
                break;
            case OPEN_USER:
                intent = YouTubeIntents.createUserIntent(this, Ids.IntentsDemoActivity.USER_ID);
                startActivity(intent);
                break;
            case OPEN_CHANNEL:
                intent = YouTubeIntents.createChannelIntent(this, Ids.IntentsDemoActivity.CHANNEL_ID);
                startActivity(intent);
                break;
            case UPLOAD_VIDEO:
