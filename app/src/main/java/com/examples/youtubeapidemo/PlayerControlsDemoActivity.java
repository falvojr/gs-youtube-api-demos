...
import com.examples.youtubeapidemo.util.ListEntry;
...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        videoAdapter = new ArrayAdapter<ListEntry>(this, android.R.layout.simple_spinner_item, Ids.PlayerControlsDemoActivity.ENTRIES);
