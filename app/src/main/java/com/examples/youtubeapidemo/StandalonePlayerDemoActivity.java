    ...
    public void onClick(View v) {
        ...
        if (v == playVideoButton) {
            intent = YouTubeStandalonePlayer.createVideoIntent(
                    this, DeveloperKey.DEVELOPER_KEY, Ids.StandalonePlayerDemoActivity.VIDEO_ID, startTimeMillis, autoplay, lightboxMode);
        } else if (v == playPlaylistButton) {
            intent = YouTubeStandalonePlayer.createPlaylistIntent(this, DeveloperKey.DEVELOPER_KEY,
                    Ids.StandalonePlayerDemoActivity.PLAYLIST_ID, startIndex, startTimeMillis, autoplay, lightboxMode);
        } else if (v == playVideoListButton) {
            intent = YouTubeStandalonePlayer.createVideosIntent(this, DeveloperKey.DEVELOPER_KEY,
                    Ids.StandalonePlayerDemoActivity.VIDEO_IDS, startIndex, startTimeMillis, autoplay, lightboxMode);
        }
